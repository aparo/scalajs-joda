...
object DateMidnight {
   ...
   * @since 2.0
   */
  @FromString def parse(str: String): DateMidnight = {
  ...
  final class Property extends AbstractReadableInstantFieldProperty {
    ...
    private var iInstant: DateMidnight = null
     ...
     */
    private[time] def this(instant: DateMidnight, field: DateTimeField) {
      this()
      `super`
      iInstant = instant
      iField = field
     ...
     * @return the datetime
     */
    def getDateMidnight: DateMidnight = {
      return iInstant
    }
     ...
     * @throws IllegalArgumentException if the text value isn't valid
     */
    def setCopy(text: String): DateMidnight = {
     ...
     * @since 1.2
     */
    def withMaximumValue: DateMidnight = {
     ...
     * @since 1.2
     */
    def withMinimumValue: DateMidnight = {
...
@deprecated
@SerialVersionUID(156371964018738L)
final class DateMidnight extends BaseDateTime with ReadableDateTime with Serializable {
  /**
   ...
   */
  protected override def checkInstant(instant: Long, chronology: Chronology): Long = {
  ...
  def withMillis(newMillis: Long): DateMidnight = {
    ...
    return (if (newMillis == getMillis) this else new DateMidnight(newMillis, chrono))
  }
  ...
  def withChronology(newChronology: Chronology): DateMidnight = {
    return (if (newChronology eq getChronology) this else new DateMidnight(getMillis, newChronology))
  }
   ...
   * @throws ArithmeticException if the new datetime exceeds the capacity of a long
   */
  def plus(duration: Long): DateMidnight = {
   ...
   * @throws ArithmeticException if the new datetime exceeds the capacity of a long
   */
  def plus(period: ReadablePeriod): DateMidnight = {
   ...
   * @throws ArithmeticException if the new datetime exceeds the capacity of a long
   */
  def minus(duration: Long): DateMidnight = {
    return withDurationAdded(duration, -1)
  }
   ...
   * @throws ArithmeticException if the new datetime exceeds the capacity of a long
   */
  def minus(period: ReadablePeriod): DateMidnight = {
    return withPeriodAdded(period, -1)
  }
   ...
   */
  def property(`type`: DateTimeFieldType): DateMidnight.Property = {
    if (`type` == null) {
    ...
    return new DateMidnight.Property(this, field)
  }
  ...
  def toInterval: Interval = {
    val chrono: Chronology = getChronology
    val start: Long = getMillis
    val end: Long = DurationFieldType.days.getField(chrono).add(start, 1)
   ...
   */
  def centuryOfEra: DateMidnight.Property = {
   ...
   * @return the year of era property
   */
  def yearOfCentury: DateMidnight.Property = {
   ...
   * @return the year of era property
   */
  def yearOfEra: DateMidnight.Property = {
   ...
   */
  def year: DateMidnight.Property = {
   ...
   */
  def weekyear: DateMidnight.Property = {
   ...
   */
  def monthOfYear: DateMidnight.Property = {
   ...
   */
  def weekOfWeekyear: DateMidnight.Property = {
   ...
   */
  def dayOfYear: DateMidnight.Property = {
   ...
   */
  def dayOfMonth: DateMidnight.Property = {
   ...
   */
  def dayOfWeek: DateMidnight.Property = {
