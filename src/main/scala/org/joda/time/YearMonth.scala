 ...
 * <p>
 * Calculations on YearMonth are performed using a {@link org.joda.Chronology}.
...
object YearMonth {
  ...
  private val FIELD_TYPES: Array[DateTimeFieldType] = Array[DateTimeFieldType](DateTimeFieldType.year, DateTimeFieldType.monthOfYear)
  /** The index of the year field in the field array */
  val YEAR: Int = 0
  /** The index of the monthOfYear field in the field array */
  val MONTH_OF_YEAR: Int = 1
   ...
   * @since 2.0
   */
  @FromString def parse(str: String): YearMonth = {
   ...
   * @throws IllegalArgumentException if the year or month is invalid for the ISO chronology
   */
  @SuppressWarnings(Array("deprecation")) def fromDateFields(date: Date): YearMonth = {
    if (date == null) {
  ...
  class Property extends AbstractPartialFieldProperty with Serializable {
    /** The partial */
    private final val iBase: YearMonth = null
    /** The field index */
     ...
     */
    private[time] def this(partial: YearMonth, fieldIndex: Int) {
      this()
      `super`
      iBase = partial
     ...
     */
    def addToCopy(valueToAdd: Int): YearMonth = {
     ...
     * @throws IllegalArgumentException if the value isn't valid
     */
    def addWrapFieldToCopy(valueToAdd: Int): YearMonth = {
      var newValues: Array[Int] = iBase.getValues
     ...
     * @throws IllegalArgumentException if the value isn't valid
     */
    def setCopy(value: Int): YearMonth = {
      var newValues: Array[Int] = iBase.getValues
     ...
     */
    def setCopy(text: String, locale: Locale): YearMonth = {
      var newValues: Array[Int] = iBase.getValues
     ...
     * @throws IllegalArgumentException if the text value isn't valid
     */
    def setCopy(text: String): YearMonth = {
...
@SerialVersionUID(797544782896179L)
final class YearMonth extends BasePartial with ReadablePartial with Serializable {
  /**
   ...
   * @param chronology  the chronology, null means ISOChronology in the default zone
   */
  def this(year: Int, monthOfYear: Int, chronology: Chronology) {
    this()
    `super`(Array[Int](year, monthOfYear), chronology)
  }
   ...
   */
  private[time] def this(partial: YearMonth, values: Array[Int]) {
    this()
   ...
   */
  private[time] def this(partial: YearMonth, chrono: Chronology) {
    this()
  ...
  override def getFieldType(index: Int): DateTimeFieldType = {
    return YearMonth.FIELD_TYPES(index)
  }
  ...
  override def getFieldTypes: Array[DateTimeFieldType] = {
    return YearMonth.FIELD_TYPES.clone.asInstanceOf[Array[DateTimeFieldType]]
  }
   ...
   */
  def withChronologyRetainFields(newChronology: Chronology): YearMonth = {
    ...
    if (newChronology eq getChronology) {
      ...
      val newYearMonth: YearMonth = new YearMonth(this, newChronology)
   ...
   */
  def withField(fieldType: DateTimeFieldType, value: Int): YearMonth = {
   ...
   */
  def withFieldAdded(fieldType: DurationFieldType, amount: Int): YearMonth = {
    val index: Int = indexOfSupported(fieldType)
    if (amount == 0) {
      return this
    }
   ...
   * @throws ArithmeticException if the new date-time exceeds the capacity
   */
  def withPeriodAdded(period: ReadablePeriod, scalar: Int): YearMonth = {
   ...
   */
  def plus(period: ReadablePeriod): YearMonth = {
   ...
   */
  def plusYears(years: Int): YearMonth = {
   ...
   */
  def plusMonths(months: Int): YearMonth = {
   ...
   * @throws ArithmeticException if the new year-month exceeds the capacity
   */
  def minus(period: ReadablePeriod): YearMonth = {
    return withPeriodAdded(period, -1)
  }
   ...
   */
  def minusYears(years: Int): YearMonth = {
   ...
   */
  def minusMonths(months: Int): YearMonth = {
   ...
   */
  def toLocalDate(dayOfMonth: Int): LocalDate = {
  ...
  def toInterval(zone: DateTimeZone): Interval = {
    ...
    val start: DateTime = toLocalDate(1).toDateTimeAtStartOfDay(zone)
    val end: DateTime = plusMonths(1).toLocalDate(1).toDateTimeAtStartOfDay(zone)
   ...
   */
  def getYear: Int = {
    return getValue(YearMonth.YEAR)
  }
  ...
  def getMonthOfYear: Int = {
    return getValue(YearMonth.MONTH_OF_YEAR)
  }
  ...
  def withYear(year: Int): YearMonth = {
    var newValues: Array[Int] = getValues
    newValues = getChronology.year.set(this, YearMonth.YEAR, newValues, year)
    return new YearMonth(this, newValues)
  }
  ...
  def withMonthOfYear(monthOfYear: Int): YearMonth = {
    var newValues: Array[Int] = getValues
    newValues = getChronology.monthOfYear.set(this, YearMonth.MONTH_OF_YEAR, newValues, monthOfYear)
    return new YearMonth(this, newValues)
  }
   ...
   */
  def property(`type`: DateTimeFieldType): YearMonth.Property = {
    return new YearMonth.Property(this, indexOfSupported(`type`))
  }
   ...
   */
  def year: YearMonth.Property = {
    return new YearMonth.Property(this, YearMonth.YEAR)
  }
   ...
   */
  def monthOfYear: YearMonth.Property = {
    return new YearMonth.Property(this, YearMonth.MONTH_OF_YEAR)
  }
